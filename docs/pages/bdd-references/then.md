...
------------------------
### [Then](#){: .p-1 .text-red-200} its value must be [action](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} than [number](#){: .p-1 .text-grey-lt-000 .bg-blue-300} 
...
than 
[number](#){: .p-1 .text-grey-lt-000 .bg-blue-300} 
>
> ▪
[Then](#){: .p-1 .text-red-200} 
...
| key | Description | Examples |
|:---:|:----------|:-|
| [action](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} | mathematical operator | Only supports for : <br>▪ `more` `greater` `bigger`<br>▪ `more and equal` `greater and equal` `bigger and equal`<br>▪ `less and equal` `lesser and equal` `smaller and equal`<br>▪ `equal`|
| [number](#){: .p-1 .text-grey-lt-000 .bg-blue-300}  | integer | `1` `20` `-40` |

------------------------
### [Then](#){: .p-1 .text-red-200} its value [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} match the "[search regex](#){: .p-1 .text-grey-lt-000 .bg-blue-300}" regex
...
[condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} 
match the  
"[search_regex](#){: .p-1 .text-grey-lt-000 .bg-blue-300}" 
regex
>
| key | Description | Examples |
|:---:|:----------|:-|
| [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} | defines positive or negative comparison | Only supports for : <br>▪ Leave it empty for positive comparison<br>▪ Use `must not` for negative comparison |
| [search_regex](#){: .p-1 .text-grey-lt-000 .bg-blue-300}  | any valid regular expression | `^some_name$` `^(you|can|use|or|like|this)$` `\d+` |

__Please note that__, in case you are using a [Scenario Outline instead of a Scenario](/pages/bdd-references/#scenario)
and if you need to use `|` (or) regular expression operator within your [search_regex](#){: .p-1 .text-grey-lt-000 .bg-blue-300} 
regex, then you must use escape characters (`\`) for not to interfere with Scenario Outline structure. In these situations
use `\|` instead of `|`.

------------------------
### [Then](#){: .p-1 .text-red-200} its value [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} be [something](#){: .p-1 .text-grey-lt-000 .bg-blue-300}
...
| key | Description | Examples |
|:---:|:----------|:-|
| [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} | defines positive or negative comparison | Only supports for : <br>▪ `must`<br>▪ `must not` |
| [something](#){: .p-1 .text-grey-lt-000 .bg-blue-300}  | search value | `some_name` |

------------------------
### [Then](#){: .p-1 .text-red-200} its value [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} contain [something](#){: .p-1 .text-grey-lt-000 .bg-blue-300}
...
------------------------
### [Then](#){: .p-1 .text-red-200} its value [condition](#){: .p-1 .text-grey-dk-100 .bg-yellow-200} be null
