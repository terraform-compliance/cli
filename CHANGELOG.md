...
## 1.2.9 (2020-07-10)
* Improve the code quality of live debugging. Use `world.config.user_data` instead of global variables. ([#320](https://github.com/eerkunt/terraform-compliance/pull/320))
