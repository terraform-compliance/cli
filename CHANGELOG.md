...
* Added a new step: `Then it must not be in` ([docs](https://terraform-compliance.com/pages/bdd-references/then.html#then-it-condition-be-in-haystack) [#562](https://github.com/terraform-compliance/cli/issues/562))

## 1.3.28 (2021-09-16)
* Added more support for ambiguous resources without having any "values" ([#554](https://github.com/terraform-compliance/cli/issues/554))
