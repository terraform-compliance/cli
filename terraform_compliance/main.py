...
def cli(arghandling=ArgHandling(), argparser=ArgumentParser(prog=__app_name__,
    ...
    parser.add_argument("--terraform", "-t", dest="terraform_file", metavar='terraform plan file', type=str, nargs='?',
                        help="Terraform executable that will be used for internal purposes", required=False)
