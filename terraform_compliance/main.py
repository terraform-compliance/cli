...
def cli(arghandling=ArgHandling(), argparser=ArgumentParser(prog=__app_name__,
    ...
    parser.add_argument("--junit", "-j", dest="junit_file", metavar='junit_file', type=str, nargs='?',
                        help="Test JUnit file to create", required=False)
    ...
    commands = ['radish',
                ...
                '--junit-xml={}'.format(args.junit_file)]
